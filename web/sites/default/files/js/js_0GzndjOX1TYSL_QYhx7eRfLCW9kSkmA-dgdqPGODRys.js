...
(function ($, Drupal, drupalSettings, window) {
  ...
  window.onload = function () {
    ...
    if (!bootstrapVersion) {
      ...
      messages.add(
        '<a href="https://getbootstrap.com/docs/4.6/getting-started/introduction/">Bootstrap framework</a> not detected. The DXPR Builder editor depends on Bootstrap 3 or 4, including all Bootstrap javascript components. If you website does not use Bootstrap please enable Bootstrap assets in the DXPR Builder settings form.',
        { type: "error" }
      );
    } else if (bootstrapVersion === "5") {
      const messages = new Drupal.Message();
      messages.add(
        "Bootstrap 5 is not supported. DXPR Builder needs Bootstrap 3 or 4. Bootstrap 5 support will be available in Q1 2023.",
        { type: "error" }
      );
    }
  };
